  ...
  return (
    <>
      ...
      >
        ...
        <Skill name="Security" x="-20vw" y="2vw" />
        <Skill name="Tailwind" x="-5vw" y="-10vw" />
        <Skill name="JavaScript" x="20vw" y="6vw" />
        <Skill name="Ethereum" x="0vw" y="12vw" />
        <Skill name="Next.js" x="-20vw" y="-15vw" />
        <Skill name="Solidity" x="15vw" y="-12vw" />
        <Skill name="Git" x="-35vw" y="-5vw" />
        <Skill name="Foundry" x="32vw" y="-5vw" />
        <Skill name="Hardhat" x="0vw" y="-20vw" />
        <Skill name="React" x="-25vw" y="18vw" />
        <Skill name="Smart-Contract" x="28vw" y="18vw" />
      </div>
    </>
  );
};
